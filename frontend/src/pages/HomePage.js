      ...
      <section id="services" className="py-5 position-relative overflow-hidden">
        ...
        <div className="container py-5 position-relative">
          <div className="text-center mb-5">
            ...
            <h2 className="display-4 fw-bold mb-3 text-white">Premium Video Editing Services</h2>
            <p className="lead text-white opacity-75 col-lg-8 mx-auto">
          ...
          <div className="row g-4 mb-5">
            <div className="col-lg-4 col-md-6">
              <div className="service-card card h-100 border-0 shadow-lg position-relative overflow-hidden" 
                ...
                <div className="card-body p-4 text-center">
                  ...
                  <h4 className="card-title mb-3 text-dark">Short Form Videos</h4>
                  <p className="card-text text-dark opacity-75 mb-4">
                    Perfect for social media, reels, and quick promotional content. 
                    Engaging edits that capture attention in seconds.
                  </p>
                  <ul className="list-unstyled text-start small">
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Instagram Reels</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>YouTube Shorts</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>TikTok Videos</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Promotional Clips</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card card h-100 border-0 shadow-lg position-relative overflow-hidden"
                ...
                <div className="card-body p-4 text-center">
                  ...
                  <h4 className="card-title mb-3 text-dark">Long Form Content</h4>
                  <p className="card-text text-dark opacity-75 mb-4">
                    Comprehensive editing for documentaries, tutorials, and extended content 
                    that tells your complete story.
                  </p>
                  <ul className="list-unstyled text-start small">
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>YouTube Videos</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Documentaries</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Tutorials</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Webinars</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card card h-100 border-0 shadow-lg position-relative overflow-hidden"
                ...
                <div className="card-body p-4 text-center">
                  ...
                  <h4 className="card-title mb-3 text-dark">Motion Graphics</h4>
                  <p className="card-text text-dark opacity-75 mb-4">
                    Dynamic animations and graphics that bring your content to life 
                    with professional visual effects.
                  </p>
                  <ul className="list-unstyled text-start small">
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Logo Animations</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Lower Thirds</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Transitions</li>
                    <li className="mb-2 text-dark"><i className="bi bi-check text-success me-2"></i>Visual Effects</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {/* Process Timeline */}
          <div className="text-center mb-5">
            <h3 className="fw-bold mb-4 text-white">Our Simple Process</h3>
            <div className="row g-4">
              <div className="col-lg-3 col-md-6">
                <div className="process-step text-center">
                  ...
                  <h5 className="text-white">Upload Content</h5>
                  <p className="text-white opacity-75 small">Share your raw footage and project requirements with us</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6">
                <div className="process-step text-center">
                  ...
                  <h5 className="text-white">We Edit</h5>
                  <p className="text-white opacity-75 small">Our expert team works on your project with precision</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6">
                <div className="process-step text-center">
                  ...
                  <h5 className="text-white">Review & Feedback</h5>
                  <p className="text-white opacity-75 small">Review the draft and provide feedback for adjustments</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6">
                <div className="process-step text-center">
                  ...
                  <h5 className="text-white">Final Delivery</h5>
                  <p className="text-white opacity-75 small">Receive your professionally edited video</p>
                </div>
              </div>
            </div>
          </div>
